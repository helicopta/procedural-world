...
import terrainVextexShader from './shaders/terrian/vertex.glsl'
...
//Material
debugObject.colorWaterDeep = 0x002b3d
debugObject.colorWaterSurface = 0x66a8ff
debugObject.colorSand = 0xffe894
debugObject.colorGrass = 0x85d534
debugObject.colorSnow = 0xffffff
debugObject.colorRock = 0xbfbd8d
...
const material = new CustomShaderMaterial({
    ...
    vertexShader: terrainVextexShader,
...
board.material = new THREE.MeshStandardMaterial({color: 0xffffff, metalness: 0, roughness: 0.3})
